...
const Products = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-8 border-l border-gray-300 sm:berder-none">
      <h1 className="text-2xl font-semibold text-gray-800 mb-4 border-b border-gray-300">Products</h1>
